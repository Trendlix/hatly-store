...
const AboutCard:FC<propsType> = props => {
  return (
    ...
    <div 
      ...
      {props?.points?.map(el=> <p key={el.length} className=' text-[#6f6e6e] w-full md:max-w-[275px]  max-md:p-4 max-md:my-4 max-md:rounded-md max-md:border-[3px] max-md:border-[#e4b372]'>{el}</p>)}
