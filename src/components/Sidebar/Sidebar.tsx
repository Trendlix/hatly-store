...
const SideBar: FC = (props) => {
  ...
  return (
    <div
      className={`fixed top-0 bottom-0 right-0 bg-secondary ml-1 z-[1000] w-[300px] duration-150 translate-x-[100%] ${
    ...
    >
      ...
      <ul className="flex flex-col text-start py-4 px-8">
        ...
        <li className="sidebar__element">
          <a href="#tesla">About us</a>
        </li>
        <li className="sidebar__element">
          <a href="#tesla">Our Services</a>
        </li>
        <li className="sidebar__element">
          <a href="#tesla">Events</a>
        </li>
        <li className="sidebar__element">
          <a href="#tesla">Contact Us</a>
        </li>
      </ul>
    </div>
  );
